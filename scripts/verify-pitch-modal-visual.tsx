...
const samplePitch: VacancyPitchResult = {
  ...
  emailPitch: {
    ...
    body: `Здравствуйте! Заинтересовала позиция Lead Backend Engineer в компании FinTech Cloud Platform. Буду рад узнать больше о целях и приоритетах роли.
...
В профиле подтверждён практический опыт работы со стеком: TypeScript, Node.js, PostgreSQL, Docker. В профиле нет подтверждённых фактов по требованиям: Kafka.

Буду рад обсудить цели роли и приоритеты бизнеса на коротком звонке.`,
  },
  linkedInNote: 'Здравствуйте! Заинтересовала роль Lead Backend Engineer в FinTech Cloud Platform. Мой опыт: спроектировал и запустил платежный шлюз с обработкой 15 000 RPS на Node.js и PostgreSQL. Буду рад обсудить задачи команды!',
...
Здравствуйте! Заинтересовала позиция Lead Backend Engineer в компании FinTech Cloud Platform. Буду рад узнать больше о целях и приоритетах роли.
