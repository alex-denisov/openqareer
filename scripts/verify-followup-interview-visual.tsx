...
const samplePendingFollowUps: PendingFollowUp[] = [
  {
    ...
    daysSinceApplied: 5,
    message:
      'Здравствуйте! Несколько дней назад я откликался на вакансию «Lead Backend Engineer» в компании FinTech Cloud Platform. Хотел деликатно уточнить, удалось ли вашей команде ознакомиться с откликом и на каком этапе сейчас рассмотрение кандидатов. Мой опыт и подтверждённые навыки точно соответствуют задачам роли, и я с радостью отвечу на любые вопросы.\n\nС уважением,\nАлексей Денисов',
  },
  {
    application: {
      clusterId: 'app-02',
