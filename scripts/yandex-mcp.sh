...
#
# Секрет живёт только в gitignored `openqareer.env` рядом с репозиторием и
...
PROJECT_ENV="${OPENQAREER_ENV_FILE:-$ROOT/openqareer.env}"
...
: "${YANDEX_OAUTH_TOKEN:?yandex-mcp: в openqareer.env нет YANDEX_OAUTH_TOKEN}"
