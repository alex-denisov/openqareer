...
export const tariffPackages = [
  ...
  },
  {
    ...
    points: ['Поиск и приоритизация', 'Отклики и outreach', 'Ответы и интервью'],
    note: 'Автоматизация внешних аккаунтов не продаётся до проверки выделенных test-account, receipts, лимитов и аварийного отключения.',
  },
] as const;
